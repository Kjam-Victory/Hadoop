...
public class UserManager {
	private DBHelper db;
	private static String LOG_PATH;// = "/Users/Kai_Jiang/Desktop/Logs/event.log";
	public UserManager(String log_path) {
		LOG_PATH = log_path;
		db = new DBHelper();
	}
	public boolean detectNewUser() {
		String filePath = LOG_PATH;
        String line = null;
        try {
        ...
        try {
            ...
            ugi.doAs(new PrivilegedExceptionAction<Void>() {            
                public Void run() throws Exception {
                    ...
                    fs.setOwner(new Path("/user/"+UserDirName), realUserName,"hadoop"); 
                    fs.setPermission(new Path("/user/"+UserDirName), FsPermission.createImmutable((short) 00750));
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//UserManager um = new UserManager(args[0]);
    	//um.detectNewUser();
    	DBHelper helper = new DBHelper();
    	if(helper.isGroupOwner(new User("user2", "192.168.0.8"), "readingGroup"))
